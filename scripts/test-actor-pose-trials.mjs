...
const trials = [
  ...
  {
    id: "ashfang-idle-master-v10",
    manifest: "art/generation/pose-trials/ashfang-idle-master-v10.json",
    expectedViolations: [],
    expectedSurfaceViolations: ["runtime-detail-collapse"],
    requiresReview: true,
  },
  {
    id: "ashfang-idle-master-v11",
    manifest: "art/generation/pose-trials/ashfang-idle-master-v11.json",
    expectedViolations: ["runtime-height"],
    expectedSurfaceViolations: ["runtime-detail-collapse"],
    requiresReview: true,
  },
  {
    id: "ashfang-idle-master-v12",
    manifest: "art/generation/pose-trials/ashfang-idle-master-v12.json",
    expectedViolations: [],
    expectedSurfaceViolations: ["runtime-detail-collapse"],
    requiresReview: true,
  },
